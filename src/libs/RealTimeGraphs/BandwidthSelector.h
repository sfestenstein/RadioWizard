 ...
 * @brief Bandwidth cursor state and scaling logic.
 *
...
public:
   ...
   /** @brief Enable or disable the bandwidth selector. */
   void setEnabled(bool enabled);
   [[nodiscard]] bool isEnabled() const { return _enabled; }

   /** @brief Set the half-width in Hz. */
   void setHalfWidthHz(double hz);
   [[nodiscard]] double halfWidthHz() const { return _halfWidthHz; }

   /**
    * @brief Apply a mouse-wheel delta to adjust the half-width.
   ...
   /**
    * @brief Convert the current half-width to a fraction of the given bandwidth.
